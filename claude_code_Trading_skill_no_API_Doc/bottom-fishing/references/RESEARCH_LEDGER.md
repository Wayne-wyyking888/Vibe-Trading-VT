...
- 市场级 Web risk warning 已以 Agent③ v4 接入日常流程并由独立验收器强制检查五路发现、八行业族、
  重大异动归因、事件新鲜度/A股兑现、八类输入、五域覆盖、T/T后隔离、来源 origin 和 HTML 联动；
  当前仍未完成 T-as-of 回放和 shadow 样本，只允许
